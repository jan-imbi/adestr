...
mf1_kv_prior <- function(x, n1, mu, sigma, two_armed) f1_kv_prior(x[1L,,drop=FALSE], n1, x[2L,,drop=FALSE], sigma, two_armed)
mf2_kv_prior <- function(x, n1, n2, mu, sigma, two_armed) f2_kv_prior(x[1L,,drop=FALSE], x[2L,,drop=FALSE], n1, n2, x[3L,,drop=FALSE], sigma, two_armed)
